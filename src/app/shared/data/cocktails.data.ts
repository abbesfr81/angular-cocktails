...
export const cocktails: Cocktail[] = [
  ...
  },
  {
    ...
    name: 'Margarita',
    description: 'Un cocktail mexicain classique à base de tequila, citron vert et triple sec.',
    ingredients: [
      '50ml de tequila',
  ...
  },
  {
    ...
    name: 'Caipirinha',
    description: 'Un cocktail brésilien frais et acidulé à base de cachaça et citron vert.',
    ingredients: [
      '50ml de cachaça',
  ...
  },
  {
    ...
    name: 'Piña Colada',
    description: "Un cocktail tropical sucré à base d'ananas, noix de coco et rhum.",
    ingredients: [
      '50ml de rhum blanc',
  ...
  },
  {
    ...
    name: 'Cosmopolitan',
    description: 'Un cocktail sophistiqué et fruité à base de vodka, cranberry et citron.',
    ingredients: [
      '40ml de vodka',
      '15ml de triple sec',
  ...
  },
  {
    ...
    ingredients: ['60ml de gin', '10ml de vermouth sec', 'Zeste de citron ou olive', 'Glaçons'],
  },
];
